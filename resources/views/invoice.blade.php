...
<body>
	<div class="logo">
		<a href="/api/invoice/pdf" class="btn btn-sm btn-primary">Download Pdf</a>
		<div class="row">
			<div class="col-xs-7">
			...
			<div class="col-xs-5">
				<table style="width: 100%">
					<tbody>
						<tr>
							<th>Receipt Num:</th>
							<td class="text-right"><span class="text-success caps">0119293</span></td>
						</tr>
						<tr>
							<th>Date:</th>
		...
		<table class="table">
			...
			<tbody>
				<tr>
					<td>
						<div><strong>Chicken Peri Peri</strong></div>
						
					</td>
					<td></td>
					<td class="text-right">KES 600</td>
				</tr>
				<tr>
					<td>
						<div><strong>Tomato</strong></div>
						
					</td>
					<td></td>
					<td class="text-right">KES 150</td>
				</tr>
			</tbody>
		</table>
				...
				<table style="width: 100%">
					<tbody>
						<tr style="padding: 5px">
							...
							<td style="padding: 5px" class="text-right"><strong> KES 750 </strong></td>
						</tr>
					</tbody>
				</table>
			</div>
